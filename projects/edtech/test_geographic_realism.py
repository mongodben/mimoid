...
def test_geographic_realism():
    ...
    try:
        ...
        print("   #  Name                          Birth Place                        Residence")
        print("   " + "=" * 85)
        ...
        validation_rate = (valid_combinations / total_combinations * 100) if total_combinations > 0 else 0
        ...
        if validation_rate == 100.0:
            print(f"   ✅ Perfect! All city-state combinations are geographically accurate")
        else:
