...
class Institution(BaseMongoDbDocumentSchema):
    ...
    short_name: str = Field(..., max_length=50, description="Acronym or abbreviated name")
    institution_code: str = Field(..., max_length=20, description="Unique institutional identifier")
    ...
    postal_code: str = Field(..., max_length=10, description="CEP - Brazilian postal code")
    phone: str = Field(..., max_length=20)
    email: str = Field(..., max_length=255)
    website: Optional[str] = Field(None, max_length=500)
    
    # Educational details
    institution_type: str = Field(..., max_length=50, description="University, college, vocational school")
    accreditation_level: str = Field(..., max_length=50, description="MEC accreditation level")
    ...
    annual_budget: Optional[float] = Field(None, ge=0, description="Annual budget in BRL")
    
    # Academic offerings
    degree_levels: List[str] = Field(default=[], description="Undergraduate, graduate, doctoral, etc.")
    ...
    quality_rating: Optional[str] = Field(None, max_length=10, description="MEC quality assessment")
    
    # Financial aid participation
    participates_fies: bool = Field(default=False)
    participates_prouni: bool = Field(default=False)
    scholarship_programs: List[str] = Field(default=[], description="Available scholarship programs")
...
class Student(BaseMongoDbDocumentSchema):
    ...
    ethnicity: Optional[str] = Field(None, max_length=50, description="Self-declared ethnicity")
    marital_status: Optional[str] = Field(None, max_length=20)
    
    # Emergency contact
    emergency_contact: Dict[str, str] = Field(..., description="Emergency contact information")
    
    # Educational background
    previous_education: List[Dict[str, Any]] = Field(default=[], description="Educational history")
    ...
    primary_institution_id: PyObjectId = Field(..., description="Primary enrolled institution")
    status: StudentStatus = Field(default=StudentStatus.PROSPECTIVE)
    
    # Academic metrics
    current_gpa: Optional[float] = Field(None, ge=0.0, le=10.0, description="Brazilian grading scale 0-10")
    ...
    family_income: Optional[float] = Field(None, ge=0, description="Monthly family income in BRL")
    financial_aid_eligible: bool = Field(default=False)
    receives_financial_aid: bool = Field(default=False)
    
    # Special circumstances
    disabilities: List[str] = Field(default=[], description="Accessibility requirements")
    ...
    portal_preferences: Dict[str, Any] = Field(default={}, description="User interface preferences")
...
class Program(BaseMongoDbDocumentSchema):
    ...
    name: str = Field(..., max_length=200)
    program_code: str = Field(..., max_length=50, description="Institutional program code")
    mec_code: Optional[str] = Field(None, max_length=50, description="MEC program registration code")
    
    # Program details
    degree_level: str = Field(..., max_length=50, description="Undergraduate, graduate, doctoral")
    degree_type: str = Field(..., max_length=100, description="Bachelor, Master, PhD, etc.")
    field_of_study: str = Field(..., max_length=100, description="Academic area")
    specialization: Optional[str] = Field(None, max_length=100)
    
    # Academic structure
    total_credits: int = Field(..., ge=0, description="Total credits required for completion")
    ...
    # Program description
    description: str = Field(..., max_length=2000, description="Program overview and objectives")
    ...
    core_courses: List[Dict[str, Any]] = Field(default=[], description="Required course list")
    elective_options: List[Dict[str, Any]] = Field(default=[], description="Optional courses")
    capstone_requirements: Optional[Dict[str, Any]] = Field(None, description="Final project/thesis requirements")
    
    # Financial information
    tuition_per_semester: float = Field(..., ge=0, description="Tuition cost in BRL")
    additional_fees: Dict[str, float] = Field(default={}, description="Additional program fees")
    financial_aid_available: bool = Field(default=True)
    
    # Accreditation and quality
    accreditation_status: str = Field(..., max_length=50)
    quality_rating: Optional[str] = Field(None, max_length=10, description="MEC program evaluation")
    ...
    admission_periods: List[Dict[str, Any]] = Field(default=[], description="Application deadlines")
    
    # Program statistics
    completion_rate: Optional[float] = Field(None, ge=0.0, le=1.0)
    employment_rate: Optional[float] = Field(None, ge=0.0, le=1.0)
    average_starting_salary: Optional[float] = Field(None, ge=0, description="Graduate starting salary in BRL")
    
    # Status
    is_active: bool = Field(default=True)
    start_date: datetime = Field(...)
    end_date: Optional[datetime] = Field(None, description="Program discontinuation date")
...
class Application(BaseMongoDbDocumentSchema):
    ...
    application_number: str = Field(..., max_length=50, description="System-generated application ID")
    protocol_number: str = Field(..., max_length=50, description="Government protocol number")
    ...
    requested_amount: float = Field(..., ge=0, description="Requested funding amount in BRL")
    funding_percentage: Optional[float] = Field(None, ge=0.0, le=1.0, description="Percentage of tuition covered")
    ...
    status_history: List[Dict[str, Any]] = Field(default=[], description="Status change log")
    current_stage: str = Field(default="initial_review", max_length=100)
    
    # Application data
    application_form: Dict[str, Any] = Field(..., description="Complete application form responses")
    personal_statement: Optional[str] = Field(None, max_length=5000)
    academic_goals: Optional[str] = Field(None, max_length=2000)
    
    # Financial information
    family_income_declared: float = Field(..., ge=0, description="Declared family income in BRL")
    dependents_count: int = Field(default=0, ge=0)
    employment_status: str = Field(..., max_length=50)
    previous_funding: List[Dict[str, Any]] = Field(default=[], description="Previous financial aid history")
    
    # Required documents tracking
    required_documents: List[DocumentType] = Field(..., description="List of required document types")
    submitted_documents: List[PyObjectId] = Field(default=[], description="References to submitted documents")
    missing_documents: List[DocumentType] = Field(default=[], description="Outstanding required documents")
    
    # Review process
    assigned_reviewer: Optional[PyObjectId] = Field(None, description="Staff member assigned for review")
    review_notes: List[Dict[str, Any]] = Field(default=[], description="Internal review comments")
    eligibility_check: Dict[str, Any] = Field(default={}, description="Automated eligibility verification")
    
    # Decision information
    decision: Optional[str] = Field(None, max_length=50)
    decision_reason: Optional[str] = Field(None, max_length=1000)
    approved_amount: Optional[float] = Field(None, ge=0, description="Approved funding amount in BRL")
    conditions: List[str] = Field(default=[], description="Approval conditions or requirements")
    
    # Integration with government systems
    fies_protocol: Optional[str] = Field(None, max_length=100, description="FIES system protocol")
    prouni_protocol: Optional[str] = Field(None, max_length=100, description="Prouni system protocol")
    government_status: Optional[str] = Field(None, max_length=50, description="Government system status")
    
    # Communication log
    notifications_sent: List[Dict[str, Any]] = Field(default=[], description="Communication history")
    student_inquiries: List[Dict[str, Any]] = Field(default=[], description="Student questions and responses")
...
class Document(BaseMongoDbDocumentSchema):
    ...
    document_name: str = Field(..., max_length=200, description="Original filename or document title")
    ...
    expiration_date: Optional[datetime] = Field(None, description="Document validity expiration")
    ...
    verified_by: Optional[PyObjectId] = Field(None, description="Staff member who verified")
    
    # Review information
    review_notes: Optional[str] = Field(None, max_length=1000, description="Reviewer comments")
    ...
    # Document processing
    ocr_extracted_text: Optional[str] = Field(None, description="Extracted text from OCR processing")
    extracted_data: Dict[str, Any] = Field(default={}, description="Automatically extracted document data")
    validation_results: Dict[str, Any] = Field(default={}, description="Automated validation results")
    
    # Security and compliance
    checksum: str = Field(..., description="File integrity checksum")
    digital_signature: Optional[str] = Field(None, description="Digital signature if applicable")
    encryption_status: bool = Field(default=True)
    access_log: List[Dict[str, Any]] = Field(default=[], description="Document access history")
    
    # Archive information
    archived: bool = Field(default=False)
    archive_date: Optional[datetime] = Field(None)
    retention_period: Optional[int] = Field(None, description="Retention period in years")
...
class Staff(BaseMongoDbDocumentSchema):
    ...
    employee_id: str = Field(..., max_length=50, description="Institutional employee ID")
    ...
    education: List[Dict[str, Any]] = Field(default=[], description="Educational background")
    certifications: List[Dict[str, Any]] = Field(default=[], description="Professional certifications")
    areas_of_expertise: List[str] = Field(default=[], description="Subject matter expertise")
    
    # Employment details
    hire_date: datetime = Field(...)
    employment_type: str = Field(..., max_length=50, description="Full-time, part-time, contract")
    salary_range: Optional[str] = Field(None, max_length=50, description="Salary classification")
    
    # Work assignment
    workload_percentage: int = Field(default=100, ge=0, le=100, description="Percentage of full-time equivalent")
    assigned_programs: List[PyObjectId] = Field(default=[], description="Programs staff member works with")
    maximum_applications: Optional[int] = Field(None, ge=0, description="Max applications for review")
    
    # Performance metrics
    applications_reviewed: int = Field(default=0, ge=0)
    average_review_time: Optional[float] = Field(None, ge=0, description="Average review time in hours")
    quality_score: Optional[float] = Field(None, ge=0.0, le=10.0, description="Review quality rating")
    
    # System access
    user_permissions: List[str] = Field(default=[], description="System access permissions")
    last_login: Optional[datetime] = Field(None)
    account_status: str = Field(default="active", max_length=20)
    
    # Communication preferences
    notification_preferences: Dict[str, bool] = Field(default={}, description="Email and SMS preferences")
...
class Course(BaseMongoDbDocumentSchema):
    ...
    course_code: str = Field(..., max_length=20, description="Institutional course code")
    name: str = Field(..., max_length=200)
    short_name: Optional[str] = Field(None, max_length=50)
    
    # Course details
    description: str = Field(..., max_length=2000)
    learning_objectives: List[str] = Field(default=[], description="Course learning outcomes")
    ...
    schedule: Dict[str, Any] = Field(default={}, description="Class schedule and timing")
    classroom: Optional[str] = Field(None, max_length=100, description="Room assignment")
    
    # Course content
    syllabus: Optional[str] = Field(None, max_length=10000, description="Detailed course syllabus")
    reading_list: List[Dict[str, Any]] = Field(default=[], description="Required and recommended readings")
    assessment_methods: List[Dict[str, Any]] = Field(default=[], description="Grading criteria and methods")
    
    # Instructor information
    primary_instructor: PyObjectId = Field(..., description="Lead instructor")
    additional_instructors: List[PyObjectId] = Field(default=[], description="Co-instructors and TAs")
...
class Enrollment(BaseMongoDbDocumentSchema):
    ...
    program_id: Optional[PyObjectId] = Field(None, description="Associated degree program")
    ...
    final_grade: Optional[float] = Field(None, ge=0.0, le=10.0, description="Final course grade")
    letter_grade: Optional[str] = Field(None, max_length=5, description="Letter grade equivalent")
    grade_points: Optional[float] = Field(None, ge=0.0, description="Grade points earned")
    ...
    notes: Optional[str] = Field(None, max_length=1000, description="Special notes or circumstances")
    
    # Financial information
    tuition_amount: Optional[float] = Field(None, ge=0, description="Tuition for this enrollment")
    financial_aid_applied: Optional[float] = Field(None, ge=0, description="Financial aid amount")
...
class Assessment(BaseMongoDbDocumentSchema):
    ...
    # Submission details
    submission_format: Optional[str] = Field(None, max_length=100, description="File, online, paper, etc.")
    ...
    rubric_scores: Dict[str, float] = Field(default={}, description="Detailed rubric scoring")
    ...
    # Academic integrity
    plagiarism_check: Optional[Dict[str, Any]] = Field(None, description="Plagiarism detection results")
    originality_score: Optional[float] = Field(None, ge=0.0, le=1.0)
    
    # Weight and importance
    weight_percentage: float = Field(..., ge=0.0, le=1.0, description="Weight in final grade calculation")
    category: Optional[str] = Field(None, max_length=50, description="Homework, exam, project, etc.")
...
class Content(BaseMongoDbDocumentSchema):
    ...
    course_id: Optional[PyObjectId] = Field(None, description="Associated course if course-specific")
    program_id: Optional[PyObjectId] = Field(None, description="Associated program if program-specific")
    
    # Content identification
    title: str = Field(..., max_length=200)
    content_type: str = Field(..., max_length=50, description="video, document, presentation, quiz, etc.")
    category: str = Field(..., max_length=100, description="lecture, assignment, reading, etc.")
    
    # Content details
    description: Optional[str] = Field(None, max_length=1000)
    learning_objectives: List[str] = Field(default=[], description="What students will learn")
    keywords: List[str] = Field(default=[], description="Searchable keywords")
    
    # File information
    file_path: Optional[str] = Field(None, max_length=1000, description="Storage path or URL")
    ...
    contributors: List[PyObjectId] = Field(default=[], description="Additional contributors")
    version: str = Field(default="1.0", max_length=20)
    
    # Educational metadata
    difficulty_level: Optional[str] = Field(None, max_length=50, description="Beginner, intermediate, advanced")
    prerequisites: List[str] = Field(default=[], description="Required knowledge")
    estimated_time: Optional[int] = Field(None, ge=0, description="Estimated study time in minutes")
    
    # Access and permissions
    visibility: str = Field(default="course", max_length=20, description="public, institution, course, private")
    access_requirements: List[str] = Field(default=[], description="Requirements to access content")
    ...
    resolution: Optional[str] = Field(None, max_length=20, description="Video resolution if applicable")
...
class FinancialAid(BaseMongoDbDocumentSchema):
    ...
    application_id: Optional[PyObjectId] = Field(None, description="Associated application")
    ...
    funding_program: FundingProgram = Field(...)
    aid_type: str = Field(..., max_length=50, description="Grant, loan, scholarship, work-study")
    
    # Award details
    award_amount: float = Field(..., ge=0, description="Total award amount in BRL")
    disbursed_amount: float = Field(default=0.0, ge=0, description="Amount actually disbursed")
    ...
    disbursement_schedule: List[Dict[str, Any]] = Field(default=[], description="Payment schedule")
    disbursement_history: List[Dict[str, Any]] = Field(default=[], description="Payment history")
    
    # Eligibility and requirements
    eligibility_criteria: Dict[str, Any] = Field(default={}, description="Qualification requirements")
    renewal_requirements: List[str] = Field(default=[], description="Requirements to maintain aid")
    gpa_requirement: Optional[float] = Field(None, ge=0.0, le=10.0)
    credit_hour_requirement: Optional[int] = Field(None, ge=0)
    
    # Status tracking
    status: str = Field(..., max_length=50, description="Active, suspended, completed, cancelled")
    ...
    repayment_terms: Optional[Dict[str, Any]] = Field(None, description="Loan repayment details")
    grace_period_months: Optional[int] = Field(None, ge=0)
    interest_rate: Optional[float] = Field(None, ge=0.0)
    
    # Performance tracking
    academic_progress: Dict[str, Any] = Field(default={}, description="Student progress monitoring")
    compliance_status: str = Field(default="compliant", max_length=50)
    warning_flags: List[str] = Field(default=[], description="Academic or financial warnings")
...
class InstitutionCollectionSchema(BaseCollectionSchema):
    ...
    indexes: List[IndexDefinition] = [
        ...
        IndexDefinition(
            name="location_index",
            keys={
                "state": IndexDirection.ASCENDING,
                "city": IndexDirection.ASCENDING
            }
        ),
        IndexDefinition(
            name="active_institutions",
            keys={"is_active": IndexDirection.ASCENDING}
        ),
        IndexDefinition(
...
class FinancialAidCollectionSchema(BaseCollectionSchema):
    ...
    indexes: List[IndexDefinition] = [
        IndexDefinition(
            name="aid_id_unique",
            keys={"aid_id": IndexDirection.ASCENDING},
            unique=True
        ),
        IndexDefinition(
            name="student_aid",
